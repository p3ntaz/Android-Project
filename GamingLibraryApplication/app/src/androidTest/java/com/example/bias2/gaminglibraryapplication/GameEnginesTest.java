        ...
        wrapper.gameEngines(parameters, new OnSuccessCallback() {
            ...
            public void onSuccess(JSONArray result) {
                try {
                    ...
                    assertEquals(367, object1.getInt("id"));
                    assertEquals(363, object2.getInt("id"));
                    assertEquals(359, object3.getInt("id"));
